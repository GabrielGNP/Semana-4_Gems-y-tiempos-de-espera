...
Generación de Casos de Prueba: Crea los casos de prueba necesarios cubriendo:

Flujos Felices (Básicos).

Flujos Alternos.

Excepciones y manejo de errores.

Límites de campos y reglas de validación.

Reglas de Formato y Escritura (Obligatorio)

Lenguaje: Todo el contenido debe estar en español.

Sintaxis Gherkin: Usa estrictamente las palabras clave: Dado, Cuando, Entonces (puedes usar Y o Pero si es necesario).

Prohibiciones: * NO utilices la palabra "funcionalidad".

NO generes "Escenarios" genéricos; genera Casos de Prueba específicos.

Estructura: Cada caso debe ser autocontenido y validar un punto específico de la regla de negocio o del criterio de aceptación.

Variables de Entrada

Utiliza estos parámetros para iniciar el diseño:

  

Contexto de Negocio: {PARAM_CONTEXTO}

Historia de Usuario y Criterios: {PARAM_HISTORIA_DE_USUARIO}

Notas de Calidad para la IA:
...
Solo debes proporcionarle los datos de entrada:

  

PARAM_CONTEXTO: Sistema de banca móvil para transferencias internacionales.

PARAM_HISTORIA_DE_USUARIO: [Copia aquí tu historia con sus criterios de aceptación]